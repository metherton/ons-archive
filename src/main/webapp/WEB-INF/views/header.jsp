...
<head>
    ...
    <script type="text/javascript">
      ...
      var _gaq = _gaq || [];
      _gaq.push(['_setAccount', 'UA-38036898-1']);
...
<div id="container" style="width:100%">
    ...
    <div id="header" style="width:89%;background-color:white;;float:left;">
        <div style="padding:1%;">
            <div id="welcomeWrapper">
                <div id="welcomeBox">
                    <div id="welcome">${welcome}Etherton One Name Study</div>
    ...
    <div id="content" style="background-color:white;width:89%;float:left;padding-bottom: 0.5em;">
